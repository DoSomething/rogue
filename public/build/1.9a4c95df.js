(window.webpackJsonp = window.webpackJsonp || []).push([
  [1],
  {
    100: function(t, e, n) {
      ...
      (e.useActivePlugin = function() {
        var t = o.useAllPluginInstancesData('docusaurus-plugin-content-docs'),
          e = r.useLocation().pathname;
        ...
        var r,
          ...
          it = function(t, e) {
            var n = t.baseTag,
              ...
              l = t.title,
              d = t.titleAttributes;
            ct(w.BODY, r), ct(w.HTML, o), ut(l, d);
            var p = {
                baseTag: st(w.BASE, n),
          ...
          pt = function(t) {
            ...
            return {
              ...
              title: dt(w.TITLE, { title: l, titleAttributes: d }, r),
            };
          },
          ht = f()(
            function(t) {
          ...
          vt =
            ...
            (a = i = (function(t) {
              function e() {
                return U(this, e), W(this, t.apply(this, arguments));
              }
              return (
                (function(t, e) {
    ...
    118: function(t, e, n) {
      ...
      var r = n(97);
      (e.getActivePlugin = function(t, e) {
        var n = Object.entries(t).find(function(t) {
          t[0];
          var n = t[1];
          return !!r.matchPath(e, { path: n.path, exact: !1, strict: !1 });
        });
        return n ? { pluginId: n[0], pluginData: n[1] } : void 0;
      }),
        (e.getLatestVersion = function(t) {
          return t.versions.find(function(e) {
            return e.name === t.latestVersionName;
          });
        }),
    ...
    90: function(t, e, n) {
      ...
      e.a = function(t) {
        ...
        Object(r.useEffect)(
          function() {
            return (
              !S && O && window.docusaurus.prefetch(T),
              function() {
                S && l && l.disconnect();
              }
            );
        ...
        var E =
            null !== (e = null == T ? void 0 : T.startsWith('#')) &&
            void 0 !== e &&
            e,
          j = !T || !O || E;
        return (
          T && O && !E && !y && m.collectLink(T),
          j
            ? o.a.createElement(
                'a',
                Object.assign(
                ...
                Object.assign(
                  ...
                  b,
                  {
                    onMouseEnter: function() {
                      A.current ||
                        (window.docusaurus.preload(T), (A.current = !0));
                    },
                    innerRef: function(t) {
                      var e, n;
                      S &&
        ...
        return {
          withBaseUrl: function(t, e) {
            return (function(t, e, n, r) {
              ...
              if (u) return e + n;
              var f = !n.startsWith(e) ? e + n.replace(/^\//, '') : n;
              return s ? t + f : f;
            })(i, n, t, e);
          },
        };
