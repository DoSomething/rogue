    ...
    81: function(e, t, r) {
      ...
      var n = r(2),
        ...
        i = {
          ...
          permalink: '/build/docs/mdx',
          editUrl:
            'https://github.com/facebook/docusaurus/edit/master/website/docs/mdx.md',
          sidebar: 'sidebar',
          previous: {
      ...
      var p = o.a.createContext({}),
        ...
        b = o.a.forwardRef(function(e, t) {
          var r = e.components,
            ...
            d = l(r),
            b = n,
            m = d[''.concat(c, '.').concat(b)] || d[b] || s[b] || a;
          return r
            ? o.a.createElement(m, i(i({ ref: t }, p), {}, { components: r }))
            : o.a.createElement(m, i({ ref: t }, p));
        });
      function m(e, t) {
        var r = arguments,
          n = t && t.mdxType;
