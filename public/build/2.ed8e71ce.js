/*! For license information please see 2.ed8e71ce.js.LICENSE.txt */
(window.webpackJsonp = window.webpackJsonp || []).push([
  [2],
  {
    102: function(e, t, a) {
      'use strict';
      var n = a(0),
        r = a.n(n).a.createContext(void 0);
      t.a = r;
    },
    103: function(e, t, a) {
      'use strict';
    ...
    93: function(e, t, a) {
      ...
      var n = a(0),
        ...
        m = function() {
          return i.a.canUseDOM
            ? d(document.documentElement.getAttribute('data-theme'))
            : s;
        },
        f = function(e) {
          try {
            localStorage.setItem('theme', d(e));
          } catch (t) {
            console.error(t);
          }
        },
        h = function() {
          var e = Object(c.a)().siteConfig,
            t = (e = void 0 === e ? {} : e).themeConfig,
            a = (t = void 0 === t ? {} : t).colorMode,
            r = (a = void 0 === a ? {} : a).disableSwitch,
            o = void 0 !== r && r,
            l = Object(n.useState)(m),
            i = l[0],
            h = l[1],
          ...
          return (
            Object(n.useEffect)(
              function() {
                document.documentElement.setAttribute('data-theme', d(i));
              },
              [i],
            ),
            Object(n.useEffect)(
            ...
            { isDarkTheme: i === u, setLightTheme: v, setDarkTheme: b }
          );
        },
        v = a(102);
      var b = function(e) {
          ...
          return r.a.createElement(
            v.a.Provider,
            { value: { isDarkTheme: a, setLightTheme: n, setDarkTheme: o } },
            e.children,
          );
        },
        g = function() {
        ...
        p = function() {
          var e = Object(c.a)().siteConfig,
            t = (e = void 0 === e ? {} : e).themeConfig,
            a = (t = void 0 === t ? {} : t).announcementBar,
            r = (a = void 0 === a ? {} : a).id,
            o = void 0 === r ? 'annoucement-bar' : r,
            ...
            Object(n.useEffect)(function() {
              if (o) {
                var e = localStorage.getItem('docusaurus.announcement.id'),
                  t = o !== e;
                localStorage.setItem('docusaurus.announcement.id', o),
                  t &&
      ...
      var E = function(e) {
          var t = g(),
            ...
            o = p(),
            c = o.isAnnouncementBarClosed,
            l = o.closeAnnouncementBar;
          return r.a.createElement(
            k.a.Provider,
            {
              value: {
      ...
      var _ = function() {
          var e = Object(c.a)().siteConfig,
            ...
            i = n.textColor,
            s = Object(O.a)(),
            u = s.isAnnouncementBarClosed,
            d = s.closeAnnouncementBar;
          return !o || u
            ? null
            : r.a.createElement(
                'div',
                {
                  className: y.a.announcementBar,
                  style: { backgroundColor: l, color: i },
                  role: 'banner',
                },
                r.a.createElement('div', {
                  className: y.a.announcementBarContent,
                ...
                r.a.createElement(
                  ...
                  {
                    type: 'button',
                    className: y.a.announcementBarClose,
                    onClick: d,
                    'aria-label': 'Close',
                  },
        ...
        I = function(e) {
          ...
          return r.a.createElement(
            'span',
            { className: Object(w.a)(B.a.toggle, B.a.dark), style: a },
            t,
          );
        },
        M = function(e) {
          ...
          return r.a.createElement(
            'span',
            { className: Object(w.a)(B.a.toggle, B.a.light), style: a },
            t,
          );
        },
        P = function(e) {
          var t = Object(c.a)(),
            a = t.siteConfig.themeConfig.colorMode.switchConfig,
            n = a.darkIcon,
            o = a.darkIconStyle,
            l = a.lightIcon,
            i = a.lightIconStyle,
            ...
            Object(C.a)(
              {
                disabled: !s,
                icons: {
                  checked: r.a.createElement(I, { icon: n, style: o }),
                  unchecked: r.a.createElement(M, { icon: l, style: i }),
                },
              },
              e,
            ),
        ...
        U = function(e) {
          var t = Object(n.useState)(!0),
            ...
            h = Object(n.useCallback)(function(e) {
              null !== e && f(e.getBoundingClientRect().height);
            }, []),
          ...
          return (
            Object(X.a)(
              function(t) {
                var a = t.scrollY;
                if (e && (0 === a && r(!0), !(a < m))) {
                  if (c) return l(!1), r(!1), void u(a);
                  var n = document.documentElement.scrollHeight - m,
                    o = window.innerHeight;
                  s && a >= s ? r(!1) : a + o < n && r(!0), u(a);
                }
              },
              [s, m],
            ),
      ...
      function z(e) {
        var t = e.activeBasePath,
          ...
          m = Object(l.a)(n),
          f = Object(l.a)(t),
          h = Object(l.a)(o, { forcePrependBaseUrl: !0 });
        return r.a.createElement(
          N.a,
          Object(C.a)(
            {},
            o
              ...
              : Object.assign(
                  { isNavLink: !0, activeClassName: s, to: m },
                  t || a
                    ? {
                        isActive: function(e, t) {
                          return a
                            ? new RegExp(a).test(t.pathname)
                            : t.pathname.startsWith(f);
                        },
                      }
                    : null,
                ),
      ...
      function J(e) {
        var t = e.items,
          a = e.position,
          n = e.className,
          o = Object(W.a)(e, ['items', 'position', 'className']),
          c = function(e, t) {
            return (
              void 0 === t && (t = !1),
              Object(w.a)(
        ...
        return t
              ...
              r.a.createElement(
                ...
                Object(C.a)({ className: c(n) }, o, {
                  ...
                  onKeyDown: function(e) {
                    ...
                    'Enter' !== e.key || o.to || t(), 'Tab' === e.key && t();
                  },
                }),
                o.label,
              ),
          ...
          : r.a.createElement(z, Object(C.a)({ className: c(n) }, o));
      }
      function K(e) {
        var t = e.items,
          a = (e.position, e.className),
          n = Object(W.a)(e, ['items', 'position', 'className']),
          o = function(e, t) {
            return (
              void 0 === t && (t = !1),
              Object(w.a)('menu__link', { 'menu__link--sublist': t }, e)
            );
          };
        return t
          ? r.a.createElement(
          ...
          : r.a.createElement(
              'li',
              { className: 'menu__list-item' },
              r.a.createElement(z, Object(C.a)({ className: o(a) }, n)),
            );
      }
      var q = function(e) {
          var t = e.mobile,
            a = void 0 !== t && t,
            n = Object(W.a)(e, ['mobile']),
            o = a ? K : J;
          return r.a.createElement(o, n);
        },
        Q = a(100);
      var Z = function(e, t) {
          return 'next' === e.name ? t : e.name;
        },
        $ = function(e) {
      ...
      var ee = {
        ...
        docsVersion: function(e) {
          var t = e.label,
            ...
            l = Object(Q.useActiveVersion)(n),
            i = Object(Q.useLatestVersion)(n),
            s = null != l ? l : i,
            u =
              null != t
                ? t
          ...
          return r.a.createElement(q, Object(C.a)({}, c, { label: u, to: d }));
        },
        docsVersionDropdown: function(e) {
          var t,
            ...
            n = e.docsPluginId,
            o = e.nextVersionLabel,
            c = Object(W.a)(e, ['mobile', 'docsPluginId', 'nextVersionLabel']),
            l = Object(Q.useActiveDocContext)(n),
            i = Object(Q.useVersions)(n),
            s = Object(Q.useLatestVersion)(n),
            u = i.map(function(e) {
              var t =
                (null == l ? void 0 : l.alternateDocVersions[e.name]) || $(e);
              return {
                isNavLink: !0,
                label: Z(e, o),
                to: t.path,
            ...
            d = null !== (t = l.activeVersion) && void 0 !== t ? t : s,
            m = a ? 'Versions' : Z(d, o),
            f = a ? void 0 : $(d).path;
          return r.a.createElement(
            q,
            Object(C.a)({}, c, { mobile: a, label: m, to: f, items: u }),
          );
        },
      };
      function te(e) {
          ...
          return r.a.createElement(
            'nav',
            {
              ...
              className: Object(w.a)(
                ...
                'navbar--light',
                'navbar--fixed-top',
                ((e = { 'navbar-sidebar--show': k }),
                (e[Y.a.navbarHideable] = f),
                (e[Y.a.navbarHidden] = !M),
                e),
              ),
            },
            r.a.createElement(
              ...
              r.a.createElement(
                ...
                r.a.createElement(
                  N.a,
                  Object(C.a)({ className: 'navbar__brand', to: V }, X),
                  null != G &&
                ...
                Z.map(function(e, t) {
                  return r.a.createElement(te, Object(C.a)({}, e, { key: t }));
                }),
              ),
              r.a.createElement(
                'div',
                ...
                !b &&
                  r.a.createElement(P, {
                    className: Y.a.displayOnlyInLargeViewport,
                    'aria-label': 'Dark mode toggle',
                    checked: T,
                    onChange: K,
                  }),
                r.a.createElement(S, {
                  handleSearchBarToggle: y,
                  isSearchBarExpanded: j,
                }),
              ),
            ),
            r.a.createElement('div', {
            ...
            r.a.createElement(
              ...
              r.a.createElement(
                ...
                r.a.createElement(
                  N.a,
                  Object(C.a)(
                    { className: 'navbar__brand', onClick: J, to: V },
                    X,
                  ),
                  null != G &&
                    r.a.createElement('img', {
                ...
                r.a.createElement(
                  ...
                  r.a.createElement(
                    ...
                    d.map(function(e, t) {
                      return r.a.createElement(
                        te,
                        Object(C.a)({ mobile: !0 }, e, { onClick: J, key: t }),
                      );
                    }),
                  ),
                ),
      ...
      function oe(e) {
        var t = e.to,
          ...
          c = Object(W.a)(e, ['to', 'href', 'label', 'prependBaseUrlToHref']),
          i = Object(l.a)(t),
                        ...
                        d.href
                          ? r.a.createElement(
                              'a',
                              {
                                ...
                                target: '_blank',
                                rel: 'noopener noreferrer',
                                className: re.a.footerLogoLink,
                              },
                              r.a.createElement(ce, { alt: d.alt, url: m }),
                            )
                          : r.a.createElement(ce, { alt: d.alt, url: m }),
                      ),
                    r.a.createElement('div', {
      ...
      function ie(e) {
        var t = e.children;
        return r.a.createElement(b, null, r.a.createElement(E, null, t));
      }
      t.a = function(e) {
        var t = Object(c.a)().siteConfig,
          a = void 0 === t ? {} : t,
          n = a.favicon,
          i = a.title,
        ...
        return r.a.createElement(
          ...
          r.a.createElement(
            ...
            k && r.a.createElement('title', null, k),
            k &&
              r.a.createElement('meta', { property: 'og:title', content: k }),
            n && r.a.createElement('link', { rel: 'shortcut icon', href: j }),
            h && r.a.createElement('meta', { name: 'description', content: h }),
            h &&
            ...
            E &&
              r.a.createElement('meta', { property: 'og:image', content: O }),
            E &&
              r.a.createElement('meta', {
            ...
            g &&
              r.a.createElement('meta', { property: 'og:url', content: u + g }),
            g && r.a.createElement('link', { rel: 'canonical', href: u + g }),
            r.a.createElement('meta', {
              name: 'twitter:card',
