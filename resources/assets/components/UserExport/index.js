...
const UserExport = props => (
  <div className="user-export">
    ...
    <p>
      Generate a .csv of all users signed via web and who have opted
      in to receive additional messaging. The generated file will be
      emailed to you when complete.
    </p>
    <div>
