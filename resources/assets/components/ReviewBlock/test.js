...
test('it renders an active Accept button when clicked', () => {
  ...
  component
    .find('StatusButton')
    .findWhere(n => n.prop('type') === 'accepted')
    .simulate('click');
  ...
  expect(
    component
      ...
      .findWhere(n => n.prop('type') === 'accepted')
      .first()
      .hasClass('button -accepted is-loading'),
  );
  ...
  expect(
    component
      .find('StatusButton')
      .findWhere(n => n.prop('type') === 'rejected')
      .first()
      .hasClass('button -outlined-button -rejected'),
  );
});
...
test('it renders an active Reject button when clicked', () => {
  ...
  expect(
    component
      ...
      .findWhere(n => n.prop('type') === 'accepted')
      .first()
      .hasClass('button -rejected is-loading'),
  );
  ...
  expect(
    component
      ...
      .findWhere(n => n.prop('type') === 'rejected')
      .first()
      .hasClass('button -outlined-button -accepted'),
  );
});
