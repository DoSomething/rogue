...
class GroupTypeTest extends TestCase
{
    ...
    public function testAdminCanCreateGroupType()
    {
        ...
        $this->actingAsAdmin()->postJson('group-types', ['name' => $name])->assertStatus(302);
        ...
        $this->actingAsAdmin()->postJson('group-types', ['name' => $name])->assertStatus(422);
    }
    ...
    public function testStaffCannotCreateGroupType()
    {
        ...
        $this->actingAsStaff()->postJson('group-types', ['name' => $name])->assertStatus(403);
